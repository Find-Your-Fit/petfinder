...
def preprocess(ori_imgs, max_size=512, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)): # *image_path
...
# def preprocess(*image_path, max_size=512, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225),img_folder=None):
#     import os
    

#     if img_folder == None:
#         img_folder = "C:/github/petfinder/Yet-Another-EfficientDet-Pytorch/dataset/resize_train"
        
        
#     os.chdir(img_folder)    
#     ori_imgs = [cv2.imread(os.path.join(img_folder,img_path[0])) for img_path in image_path]
#     # ori_imgs = [cv2.imread(img_path[0]) for img_path in image_path]
#     normalized_imgs = [(img[..., ::-1] / 255 - mean) / std for img in ori_imgs]
#     imgs_meta = [aspectaware_resize_padding(img, max_size, max_size,
#                                             means=None) for img in normalized_imgs]
#     framed_imgs = [img_meta[0] for img_meta in imgs_meta]
